...
model_path = 'mcp-best-acc-0.68250.h5'
X_train_valid = 'feature_valid.npy'
Y_train_valid_label = 'label_valid.npy'
...
predictions = emotion_classifier.predict_classes(X_train_valid)
